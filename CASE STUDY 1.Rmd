...
#Rename uploaded data

The data in 2019 was renamed.

```{r Step 2 Data Cleaning, message=FALSE, warning=FALSE}
...
# Merge Data
 ...
 Data of all the month in 2020 and 2021 will be merged into one as all_trips_2020 and all_trips_2021 respectively and all the quarters in 2019 as all_trip_2019 for appropriate comparison.
...
The merged data, all_trips_2019,all_trips_2020,and all_trips_2021 will be mutated to retrieve data that provide answers to the research question.


```{r Mutate Data, message=FALSE, warning=FALSE}
library(lubridate)
...
# Create new columns such as DATE,DAY, MONTH, YEAR AND DAY OF WEEK
...
Q1: What is the total trip length made in each year?
...
# Create new columns such as  DATE,DAY, MONTH, YEAR AND DAY OF WEEK for year 2020 and 2021.
...
# End data cleaning by selecting only the needed by deselecting unwanted data
...
This will be done separately to answer the following questions.
...
##Q1: What is the average trip length of members and casual users in 2019? 

aggregate(all_trips_2019_v3$ride_length ~ all_trips_2019_v3$member_casual, FUN = mean)

##Q2: What is the maximum trip length of members and casual users in 2019? 

aggregate(all_trips_2019_v3$ride_length ~ all_trips_2019_v3$member_casual, FUN = max)

##Q3: What is the minimum trip length of members and casual users in 2019? 

aggregate(all_trips_2019_v3$ride_length ~ all_trips_2019_v3$member_casual, FUN = min)

## Q4: What is the average daily ride time  of members compared to casual users in 2019?
...
# The average ride time by each day for members vs casual users is given below.

aggregate(all_trips_2019_v3$ride_length ~ all_trips_2019_v3$member_casual + all_trips_2019_v3$day_of_week, FUN = mean)

# Use pipe operations to analyze ridership data by customer type (members vs. casual) and day_of_week

##Q5: Find the number of rides and average duration of members vs. casual users in 2019?
...
# Create a visualization for average duration of 
...
# Compare members and casual users in 2020 using Q1 - Q5
...
## Compare members and casual users in 2021 using Q1 - Q5
